...
/* =============================================== Web Server  ==================================================
|   Below is a functional web server, that clients can post and get data directly through the block chain class |
|  =============================================================================================================*/
...
// get request made by client to get a single block
// Uses getBlock within blockchain class
...
// get request made by client to vaildate block
// Uses validateBlock within blockchain class
...
// get request made by client to get chain only for visual
// uses ChainRecon within BlockChain Class
...
// get request made by client to validate chain
// uses validateChain within BlockChain class
...
//get request made by client to get height of chain
// uses getHeight within BlockChain Class
...
// post request make by client to add blocks to the chain
// uses Blockcreator to create more blocks
...
// post request make by client to change blocks 
// Using changeDBData a development only tool 
...
// Get the html file 
fs.readFile('./privateblockchainUI.html', function (err, html) {
